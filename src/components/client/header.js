...
let nav_c_home = 'index.html';
let nav_c_booking = './booking/booking.html';
let nav_c_availability = 'availability.html';
let nav_c_account_edit = './account/account-edit.html';
let nav_c_appointment = `${c_appointment}/appointment-upcoming.html`;
let nav_c_display = './display_mode/display_mode.html';
...
if (path == `${c_appointment}/appointment-upcoming.html` ||
    ...
    img_path = `../${img_path}`;
    nav_c_home = '../index.html';
    nav_c_booking = '../booking/booking.html';
    nav_c_availability = '../availability.html';
    nav_c_account_edit = '../account/account-edit.html';
    nav_c_appointment = '../appointment/appointment-upcoming.html';
    nav_c_display = '../display_mode/display_mode.html';
} else if (path == '/src/pages/client/account/account-edit.html') {
    img_path = `../${img_path}`;
    nav_c_home = '../index.html';
    nav_c_booking = '../booking/booking.html';
    nav_c_availability = '../availability.html';
    nav_c_account_edit = './account-edit.html';
    nav_c_appointment = `${c_appointment}/appointment-upcoming.html`;
    nav_c_display = '../display_mode/display_mode.html';
} else if (path == '/src/pages/client/booking/booking.html') {
    img_path = `../${img_path}`;
    nav_c_home = '../index.html';
    ...
    nav_c_appointment = `${c_appointment}/appointment-upcoming.html`;
    nav_c_display = '../display_mode/display_mode.html';
} else if (path == '/src/pages/client/display_mode/display_mode.html') {
    img_path = `../${img_path}`;
    nav_c_home = '../index.html';
    nav_c_booking = './booking/booking.html';
    nav_c_availability = '../availability.html';
...
clientHeader.innerHTML = `
    <nav class="navbar navbar-light navbar-expand-md" 
         style="background: linear-gradient(to left, rgb(74, 80, 181), rgb(50,53,101) 40%);color: rgb(255,255,255);">
    <div class="container-fluid">
        <img src="${img_path}" style="width: 50px;height: 50px;" />
        <a class="navbar-brand" href="${nav_c_home}"
            style="margin: 0px 0px 0px -130px;color: rgb(255,255,255);">AmourAila</a>
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="${nav_c_availability}"
                        style="color: rgb(255,255,255);">Availability</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="${nav_c_booking}" style="color: rgb(255,255,255);">Booking</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="${nav_c_appointment}"
                        style="color: rgb(255,255,255);">Appointment</a>
                </li>
                <li class="nav-item dropdown"><a aria-expanded="false" data-bs-toggle="dropdown"
                        class="dropdown-toggle nav-link text-light" href="#">Settings</a>
                ...
                <div class='d-flex flex-row justify-content-evenly'>
                    <button class="btn btn-warning m-1" type="button" style="width: 150px;" onclick='clientLogout()'>
