...
const loginPage = () => {
    window.location.href = '/src/pages/guest/login/login.html';
}
...
Header.innerHTML = `
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="${navigation_home}"
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="${navigation_home}" style="color: rgb(255,255,255);">Home</a>
                </li>
                <li class="nav-item">
                ...
                <div class='d-flex flex-row justify-content-evenly'>
                    <button class="btn btn-primary m-1" type="button" style="width: 150px;" onclick='loginPage()'>
