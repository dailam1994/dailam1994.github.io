...
let nav_a_home = 'index.html';
let nav_a_display = './display_mode/display_mode.html';
...
if (path == `${a_work_schedule}/work-schedule.html` ||
    ...
    img_path = `../${img_path}`;
    nav_a_home = '../index.html';
    nav_a_display = '../display_mode/display_mode.html';
...
} else if (path == '/src/pages/admin/display_mode/display_mode.html') {
    img_path = `../${img_path}`;
    nav_a_home = '../index.html';
...
adminHeader.innerHTML = `
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="${nav_a_home}"
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="${nav_a_work_schedule}" style="color: rgb(255,255,255);">Work
                        Schedule</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="${nav_a_appointment}"
                ...
                <div class='d-flex flex-row justify-content-evenly'>
                    <button class="btn btn-warning m-1 mt-2" type="button" style="width: 150px;"
                        onclick='adminLogout()'>
